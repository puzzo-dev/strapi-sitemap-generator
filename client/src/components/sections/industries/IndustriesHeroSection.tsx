...
interface IndustriesHeroSectionProps extends PageSection {
    isLoading?: boolean;
}

const IndustriesHeroSection: React.FC<IndustriesHeroSectionProps> = ({
    title,
    subtitle,
    settings,
    isLoading
    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
                ...
                {/* Industry pattern icons */}
                <Building2 className="absolute top-20 left-20 h-40 w-40 text-blue-200/20 dark:text-blue-800/10 transform -translate-x-1/4 -translate-y-1/4 animate-float" />
                <Factory className="absolute bottom-20 right-20 h-32 w-32 text-indigo-200/20 dark:text-indigo-700/20 transform rotate-12 animate-pulse-slower" />
                <ShoppingCart className="absolute top-32 right-32 h-24 w-24 text-cyan-200/20 dark:text-cyan-700/20 animate-pulse-light" />
                <Heart className="absolute bottom-32 left-32 h-28 w-28 text-purple-200/15 dark:text-purple-700/15 animate-float" style={{ animationDelay: '1.5s' }} />
            </div>
