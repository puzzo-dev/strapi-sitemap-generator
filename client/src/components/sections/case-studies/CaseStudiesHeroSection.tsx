        ...
        >
          ...
          >
            {heroSection?.title ? (
              ...
              <>
                <span className="gradient-text">Success Stories</span> <span className="text-blue-800 dark:text-blue-200">That</span><br />
                <span className="text-blue-800 dark:text-blue-200">Drive Innovation</span>
              </>
            )}
          </motion.h1>
          ...
          >
            {heroSection?.subtitle || "Discover how we've helped businesses transform their operations and achieve remarkable results through innovative technology solutions."}
          </motion.p>
          ...
          >
            <GradientButton
              href={heroSection?.settings?.primaryButton?.href || "/contact"}
              size="lg"
              endIcon={<ArrowRight />}
            >
              {heroSection?.settings?.primaryButton?.children || "Start Your Project"}
            </GradientButton>
            <GradientButton
              href={heroSection?.settings?.secondaryButton?.href || "/services"}
              variant="outline"
              size="lg"
            >
              {heroSection?.settings?.secondaryButton?.children || "Explore Services"}
            </GradientButton>
          </motion.div>
        </motion.div>
      </div>
