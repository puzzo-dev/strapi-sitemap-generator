            ...
            <div className="flex flex-col md:flex-row gap-10 md:gap-16 relative z-10">
              ...
              <div className="md:w-1/2">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8">
                  <div className="spec-card animate-fade-in-up p-5 md:p-6 bg-white/80 dark:bg-slate-800/70 backdrop-blur-sm shadow-lg shadow-blue-100/50 dark:shadow-blue-900/20 border-t-4 border-t-blue-500 dark:border-t-blue-400 h-full sm:min-h-[200px] flex flex-col" style={{ animationDelay: '0.1s' }}>
                    ...
                    <p className="text-base text-gray-600 dark:text-gray-300 flex-grow">Custom websites and web applications with modern technologies</p>
                  </div>
                  
                  <div className="spec-card animate-fade-in-up p-5 md:p-6 bg-white/80 dark:bg-slate-800/70 backdrop-blur-sm shadow-lg shadow-indigo-100/50 dark:shadow-indigo-900/20 border-t-4 border-t-indigo-500 dark:border-t-indigo-400 h-full sm:min-h-[200px] flex flex-col" style={{ animationDelay: '0.2s' }}>
                    ...
                    <p className="text-base text-gray-600 dark:text-gray-300 flex-grow">Cross-platform mobile applications for Android and iOS</p>
                  </div>
                  
                  <div className="spec-card animate-fade-in-up p-5 md:p-6 bg-white/80 dark:bg-slate-800/70 backdrop-blur-sm shadow-lg shadow-cyan-100/50 dark:shadow-cyan-900/20 border-t-4 border-t-cyan-500 dark:border-t-cyan-400 h-full sm:min-h-[200px] flex flex-col" style={{ animationDelay: '0.3s' }}>
                    ...
                    <p className="text-base text-gray-600 dark:text-gray-300 flex-grow">Scalable and secure cloud infrastructure deployment</p>
                  </div>
                  
                  <div className="spec-card animate-fade-in-up p-5 md:p-6 bg-white/80 dark:bg-slate-800/70 backdrop-blur-sm shadow-lg shadow-purple-100/50 dark:shadow-purple-900/20 border-t-4 border-t-purple-500 dark:border-t-purple-400 h-full sm:min-h-[200px] flex flex-col" style={{ animationDelay: '0.4s' }}>
                    ...
                    <p className="text-base text-gray-600 dark:text-gray-300 flex-grow">Custom AI integrations for business automation</p>
                  </div>
                </div>
              </div>
            </div>
