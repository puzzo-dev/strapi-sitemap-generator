    ...
    <div key={post.slug} className="group flex flex-col h-full overflow-hidden rounded-xl shadow-lg bg-white dark:bg-slate-800 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
      {post.meta_image && (
        <div className="relative h-44 md:h-40 overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 w-full p-3 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            <h3 className="text-sm font-bold text-white transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
              {post.title}
            </h3>
          </div>
        </div>
          ...
          <div className="flex items-center justify-between pt-2 border-t border-gray-100 dark:border-gray-700">
            {post.authorDetails && (
              <div className="flex items-center">
                ...
                <span className="text-xs font-medium text-gray-700 dark:text-gray-300">{post.authorDetails.full_name}</span>
              </div>
            )}
