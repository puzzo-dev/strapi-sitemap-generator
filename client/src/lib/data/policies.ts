...
export const cookiesContent: PolicyPageLayoutProps = {
  ...
  slug: "cookies",
  description:
    "Learn about how I-Varse Technologies uses cookies and similar technologies on our website.",
  content: `
...
export const accessibilityContent: PolicyPageLayoutProps = {
  ...
  content: `
    ...
    <h2>Known Issues</h2>
    <p>
      We are aware of some areas on our website that need improvement. We are actively working to address
      these issues and improve accessibility.
    </p>

    <h2>Feedback and Contact</h2>
    <p>
      We welcome your feedback on the accessibility of our website. If you experience accessibility barriers
    ...
    <address>
      ...
      4 Adana Street, Off Tejuosho Rd,<br />
      Surulere, Lagos, Nigeria<br />
      Email: accessibility@itechnologies.ng<br />
      Phone: +234 123 456 7890
    </address>
    ...
    <p>
      ...
      We regularly review our accessibility practices and update our website accordingly.
    </p>
